...
public class Exercicio3 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			{
				//mostrar o índice de cada item (chamei de código p/ o usuario entender)
				exibir(estoque);
				
				//Pedir o índice
				System.out.print("Informe o código do item que deseja remover: ");
	...
	public static void exibir (ArrayList lista) {
		...
		for (int i = 0; i < lista.size(); i++) {
			System.out.println("Código do produto: "+i+
					...
					"/ Preço: "+((ItensEstoque) lista.get(i)).getPreco()+
